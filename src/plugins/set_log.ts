...
export default fp(async function (fastify, opts) {
    fastify.decorate('set_log', function (error_code: string = '', error: FastifyError | {stack:any,message:any}, res: FastifyReply, req: FastifyRequest): string {
        ...
        var streams = [
            ...
            { level: 'fatal', stream: fs.createWriteStream('logs/fatal.log', { flags: 'a' }) }
        ]
        ...
        // }
            ...
            log = pino({
                ...
                { level: 'fatal', stream: fs.createWriteStream('logs/404.log', { flags: 'a' }) },
                { stream: require('pino-pretty')() }
            ]));
...
declare module 'fastify' {
    export interface FastifyInstance {
        /**
         ...
         ```
         */
        set_log(error_code: string, error: FastifyError | {}, res: FastifyReply, req: FastifyRequest): string;
    }
}
